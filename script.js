(function () {
  ...
  /* ── CV Download ── */
  const CV_LINK_PLACEHOLDER = "https://drive.google.com/drive/folders/1F_bFFEfdrqWd4n-OFqmRWLRjonDlcuRV";
  ...
  const PROJECTS = [
    ...
    },
    {
      ...
      description: "LamarLog — Personal Job Application Tracker untuk mencatat, memantau, dan mengelola seluruh perjalanan lamaran kerja dalam satu tempat.",
      type: "Personal Project · Web Application",
      tags: ["PHP", "MySQL", "JavaScript"],
      demoLink: "https://lamarlog.wuaze.com/",
      githubLink: "#", // TODO: Ganti dengan URL GitHub Repository
      preview: "assets/lamar-log.png",
      gradientClass: "project-image-bg--2",
    },
    {
      id: "project-6",
